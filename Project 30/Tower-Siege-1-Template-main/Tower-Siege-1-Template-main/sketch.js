...
function setup() {
  ...
  block22 = new Block(640,135,30,40)
  block23 = new Block(670,135,30,40)
  block24 = new Block(700,135,30,40)
  block25 = new Block(670,95,30,40)

  polygon1 = new polygon(50, 50, 30, 30);

  slingShot = new SlingShot(polygon1.box, {x:50, y:200});
...
function mouseDragged(){
  Matter.Body.setPosition(polygon1.box, {x:mouseX, y:mouseY})
}
